...
public class kmeansPlant
{
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        r1.read("/Users/tazeen/Desktop/Project3_Power_Consumption.csv"); //load data from file
        int k = 2;
        int max_iterations = 50;
        //Hashmap to store centroid s with index
        ...
        System.out.println("Power plant data");
